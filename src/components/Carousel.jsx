...
let data = [  {id: 'america1', city: "Cancun", photo: "/img/america/cancun.jpg"},
...
export default function Carousel() {
  ...
  return (
    <div className="carousel flex justify-center items-center">
      ...
      <div className="bg-blue-600 p-4 rounded-lg container flex flex-wrap gap-2 justify-center h-full">
      <h2 className="text-white text-xl mb-4 font-bold ">Popular Mytineraries</h2>
        <div className="container flex flex-wrap gap-2 justify-center  h-1/3">
